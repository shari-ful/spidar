...
# The Spidar class will take feature lists from developers and use them
# to look up builders in this registry.
builder_registry = TreeBuilderRegistry()

class TreeBuilder(object):
    """Turn a textual document into a Spidar object tree."""
    ...
    def initialize_soup(self, soup):
        """The Spidar object has been initialized and is now
        being associated with the TreeBuilder.

        :param soup: A Spidar object.
        """
        self.soup = soup
    ...
    def feed(self, markup):
        ...
        populating the `Spidar` object in self.soup.
...
class SAXTreeBuilder(TreeBuilder):
    """A Spidar treebuilder that listens for SAX events.
...
class HTMLTreeBuilder(TreeBuilder):
    ...
    # The HTML standard defines these as block-level elements.
    # Spidar does not treat these elements differently from other elements,
    ...
    def set_up_substitutions(self, tag):
        ...
        An HTML document may come in to Spidar as one
