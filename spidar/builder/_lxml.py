...
from spidar.builder import (
    ...
    TreeBuilder,
    XML)
from spidar.dammit import EncodingDetector
...
class LXMLTreeBuilderForXML(TreeBuilder):
    ...
    def initialize_soup(self, soup):
        """Let the Spidar object know about the standard namespace
        mapping.
    ...
    def _register_namespaces(self, mapping):
        """Let the Spidar object know about namespaces encountered
        ...
        for key, value in list(mapping.items()):
            ...
            if key and key not in self.soup._namespaces:
                # Let the Spidar object know about a new namespace.
    ...
    def start(self, name, attrs, nsmap={}):
        ...
        if len(nsmap) == 0 and len(self.nsmaps) > 1:
            ...
            # First, Let the Spidar object know about it.
