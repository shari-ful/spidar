...
from spidar.builder._htmlparser import SpidarHTMLParser
...
class TestHTMLParserTreeBuilder(SoupTest, HTMLTreeBuilderSmokeTest):
    ...
    def test_rejected_input(self):
        ...
        # different ways, but Spidar consistently raises
    ...
    def test_on_duplicate_attribute(self):
        ...
        assert_attribute(SpidarHTMLParser.REPLACE, "url3")

        # You can ignore subsequent values in favor of the first.
        assert_attribute(SpidarHTMLParser.IGNORE, "url1")
