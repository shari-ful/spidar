...
from spidar.element import SoupStrainer
from . import (
    HTML5LIB_PRESENT,
...
class TestHTML5LibBuilder(SoupTest, HTML5TreeBuilderSmokeTest):
    ...
    def default_builder(self):
        from spidar.builder import HTML5TreeBuilder
    ...
    def test_soupstrainer(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            soup = Spidar(markup, "html5lib", parse_only=strainer)
  ...
  <body>
   <p>foo</p>
    ...
    def test_extraction(self):
        ...
        https://bugs.launchpad.net/Spidar/+bug/1782928
        """
...
"""
    ...
    def test_empty_comment(self):
        ...
        https://bugs.launchpad.net/Spidar/+bug/1806598
        """
