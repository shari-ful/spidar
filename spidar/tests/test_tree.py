...
class TestTreeModification(SoupTest):
    ...
    def test_insert_Spidar_object_inserts_children(self):
        """Inserting one Spidar object into another actually inserts all
        of its children -- you'll never combine Spidar objects.
        """
        ...
        for i in soup.descendants:
            assert not isinstance(i, Spidar)
    ...
    def test_consecutive_text_nodes(self):
        ...
        # but if you insert one next to another, Spidar will
        # handle it correctly.
