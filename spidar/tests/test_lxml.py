...
if LXML_PRESENT:
    from spidar.builder import LXMLTreeBuilder, LXMLTreeBuilderForXML
...
class TestLXMLXMLTreeBuilder(SoupTest, XMLTreeBuilderSmokeTest):
    ...
    def test_namespace_indexing(self):
        ...
        # The Spidar object includes every namespace prefix
    ...
    def test_namespace_interaction_with_select_and_find(self):
        ...
        # is registered with the Spidar object.
        ...
        # And a Tag (as opposed to the Spidar object) will
