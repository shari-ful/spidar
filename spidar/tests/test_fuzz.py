...
represent real problems with Spidar, but many are problems in
libraries that Spidar depends on, and many of the test cases
...
class TestFuzz(object):
    ...
    # https://github.com/google/oss-fuzz/blob/4ac6a645a197a695fe76532251feb5067076b3f3/projects/spidar/spidar_fuzzer.py
    #
    ...
    def fuzz_test_with_css(self, filename):
        ...
        try:
            soup = Spidar(data[1:], features=parsers[idx])
    ...
    @pytest.mark.parametrize(
        "filename", [
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5703933063462912",
    ...
    # to a string. This is an issue with Spidar which was fixed
    ...
    @pytest.mark.parametrize(
        "filename", [
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5984173902397440",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5167584867909632",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-6124268085182464",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-6450958476902400",
        ]
    )
    def test_deeply_nested_document_without_css(self, filename):
        ...
        # been fixed.
        markup = self.__markup(filename)
        Spidar(markup, 'html.parser').encode()
    ...
    @pytest.mark.parametrize(
        "filename", [
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5000587759190016",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5375146639360000",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5492400320282624",
        ]
    )
    ...
    @pytest.mark.parametrize(
        "filename", [
            "clusterfuzz-testcase-minimized-spidar_fuzzer-4670634698080256",
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5270998950477824",
        ]
    )
    ...
    @pytest.mark.parametrize(
        "filename", [
            ...
            "clusterfuzz-testcase-minimized-spidar_fuzzer-4818336571064320",

            # b')<a><math><TR><a><mI><a><p><a>'
            "clusterfuzz-testcase-minimized-spidar_fuzzer-4999465949331456",

            # b'-<math><sElect><mi><sElect><sElect>'
            "clusterfuzz-testcase-minimized-spidar_fuzzer-5843991618256896",
           
            # b'ñ<table><svg><html>'
            "clusterfuzz-testcase-minimized-spidar_fuzzer-6241471367348224",

            # <TABLE>, some ^@ characters, some <math> tags.
            "clusterfuzz-testcase-minimized-spidar_fuzzer-6600557255327744",
    ...
    def test_html5lib_parse_errors_without_css(self, filename):
        markup = self.__markup(filename)
        print(Spidar(markup, 'html5lib').encode())
    ...
    @pytest.mark.parametrize(
        "filename", [
            ...
            "clusterfuzz-testcase-minimized-spidar_fuzzer-6306874195312640",
        ]
    )
