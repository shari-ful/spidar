"""Tests of the spidar.element.PageElement class"""
import copy
import pickle
import pytest
import sys
...
"""
        encoded = Spidar(doc, 'html.parser').encode()
...
"""
    ...
    def test_prettify_accepts_formatter_function(self):
        soup = Spidar("<html><body>foo</body></html>", 'html.parser')
    ...
    def test_encoding_substitution_doesnt_happen_if_tag_is_strained(self):
        ...
        # Spidar used to try to rewrite the meta tag even if the
...
<title>Spidar: We called him Tortoise because he taught us.</title>
<link rev="made" href="mailto:2ashariful@gmail.com">
<meta name="Description" content="Spidar: an HTML parser optimized for web-scraping.">
<meta name="generator" content="Markov Approximation 1.4">
<meta name="author" content="Shariful Alam">
</head>
<body>
<a href="foo">foo</a>
<a href="foo"><b>bar</b></a>
    ...
    def test_pickle_and_unpickle_identity(self):
        ...
        assert loaded.__class__ == Spidar
