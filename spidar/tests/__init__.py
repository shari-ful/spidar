...
class SoupTest(object):
    ...
    def soup(self, markup, **kwargs):
        """Build a Spidar object from markup."""
        builder = kwargs.pop('builder', self.default_builder)
        return Spidar(markup, builder=builder, **kwargs)
    ...
    def assert_soup(self, to_parse, compare_parsed_to=None):
        """Parse some markup using Spidar and verify that
        the output markup is as expected.
        """
        builder = self.default_builder
        obj = Spidar(to_parse, builder=builder)
        ...
        # Also run some checks on the Spidar object itself:
...
<body>Goodbye.</body>
    ...
    def test_deepcopy(self):
        ...
        Spidar object, and we want to be able to copy that.
        """
...
"""
    ...
    # Spidar than tests of the tree builders. But parsers are
    ...
    def test_closing_tag_with_no_opening_tag(self):
        # Without Spidar.open_tag_counter, the </span> tag will
