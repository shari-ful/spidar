...
class CSS(object):
    ...
    Spidar object, or on the Tag you want to use as the
    ...
    def __init__(self, tag, api=soupsieve):
        ...
        access the .css attribute on the Spidar object, or on
    ...
    def _rs(self, results):
        ...
        A ResultSet is more consistent with the rest of Spidar's 
        API, and ResultSet.__getattr__ has a helpful error
        message if you try to treat a list of results as a single
        result (a common mistake).
        """
        # Import here to avoid circular import
        from spidar.element import ResultSet
    ...
    def select(self, select, namespaces=None, limit=0, flags=0, **kwargs):
        ...
        :param namespaces: A dictionary mapping namespace prefixes
            used in the CSS selector to namespace URIs. By default,
            Spidar will pass in the prefixes it encountered while
            parsing the document.
