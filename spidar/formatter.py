from spidar.dammit import EntitySubstitution
...
class Formatter(EntitySubstitution):
    ...
    def __init__(
        ...
        :param entity_substitution: A function to call to replace special
           ...
           spidar.dammit.EntitySubstitution.substitute_html and substitute_xml.
    ...
    def attributes(self, tag):
        ...
        backwards compatibility with older versions of Spidar.
