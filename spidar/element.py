...
from spidar.css import CSS
from spidar.formatter import (
    Formatter,
    HTMLFormatter,
    XMLFormatter,
)
...
class CharsetMetaAttributeValue(AttributeValueWithCharsetSubstitution):
    ...
    When Spidar parses the markup '<meta charset="utf8">', the
...
class PageElement(object):
    ...
    def insert(self, position, new_child):
        ...
        if isinstance(new_child, Spidar):
            # We don't want to end up with a situation where one Spidar
    ...
    def find_next(self, name=None, attrs={}, string=None, **kwargs):
        ...
        :rtype: spidar.element.Tag | spidar.element.NavigableString
        """
    ...
    def find_next_siblings(self, name=None, attrs={}, string=None, limit=None,
        ...
        :rtype: spidar.element.ResultSet
        """
        _stacklevel = kwargs.pop('_stacklevel', 2)
...
class NavigableString(str, PageElement):
    ...
    When Spidar parses the markup <b>penguin</b>, it will
...
class Tag(PageElement):
    ...
    def select_one(self, selector, namespaces=None, **kwargs):
        ...
        :param namespaces: A dictionary mapping namespace prefixes
           ...
           Spidar will use the prefixes it encountered while
...
class SoupStrainer(object):
    ...
    `Spidar` constructor, to parse a subset of a large
    document.
    """
